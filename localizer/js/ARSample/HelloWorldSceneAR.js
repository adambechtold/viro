...
function postPosition(positionArray) {
    postAnything({
      'position': {
        'x': positionArray[0],
        'y': positionArray[1],
...
var HelloWorldSceneAR = createReactClass({
  ...
  _postPosition(t) {
    postPosition(t.cameraTransform.position)
  },

  render: function() {
    return (
      <ViroARScene onTrackingUpdated={this._onTrackingUpdated} onCameraTransformUpdate={this._postPosition}>
